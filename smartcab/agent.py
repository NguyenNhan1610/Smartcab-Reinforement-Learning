...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5, decay='exponential'):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
        	...
        	if self.decay == 'exponential':
        		self.num_trials += 1
        		self.epsilon = math.exp(-0.01 * self.num_trials)
        	else:
        		self.epsilon -= 0.05
    ...
    def get_maxQ(self, state):
        ...
        maxAct = max(self.Q[state], key=self.Q[state].get)
...
def run():
    ...
    sim.run(tolerance=0.1, n_test=50)
